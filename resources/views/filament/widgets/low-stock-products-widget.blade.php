    ...
    <x-filament::section>
        <x-slot name="heading">
            <div class="flex items-center gap-2">
                ...
                <span class="text-lg font-semibold">Produk Stok Hampir Habis</span>
            </div>
        </x-slot>
        
        <x-slot name="description">
            Produk dengan stok kurang dari 10 unit di gudang Anda
        </x-slot>
