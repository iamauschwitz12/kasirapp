...
@once
    ...
    <x-filament::modal id="modal-scanner-gudang-keluar" width="md" class="z-50">
        ...
        <div class="flex flex-col items-center justify-center p-2">
            <div id="reader-gudang-keluar" style="width: 100%; min-height: 250px; border-radius: 0.75rem; overflow: hidden; border: 2px solid #a7f3d0; background-color: #f8fafc;"></div>
        ...
        <x-slot name="footer">
            <div class="flex gap-3 pt-2">
                <x-filament::button
                    ...
                    color="gray"
                    x-data
                    x-on:click="$dispatch('close-modal', { id: 'modal-scanner-gudang-keluar' })"
                    class="w-full"
                >
                    Tutup Scanner
                </x-filament::button>
