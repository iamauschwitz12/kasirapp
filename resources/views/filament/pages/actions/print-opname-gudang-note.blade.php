<div x-data="{
    ...
    handlePrint(event) {
        ...
        this.opnameGudangNoteData = data;
...
}" x-on:print-opname-gudang-note.window="handlePrint($event)">

    <style>
        @media screen {
            #opname-gudang-note-container {
                display: none;
            }
        }
    ...
    <div id="opname-gudang-note-container" x-show="opnameGudangNoteData">
        <template x-if="opnameGudangNoteData">
            <div style="max-width: 800px; margin: 0 auto; padding: 20px; font-family: Arial, sans-serif;">
                <div style="text-align: center; margin-bottom: 30px;">
                    <h1 style="margin: 0; font-size: 24px;">BERITA ACARA OPNAME GUDANG</h1>
                    <p style="margin: 5px 0; color: #666;">Laporan Hasil Perhitungan Stok Fisik Gudang</p>
                </div>
                    ...
                    <div>
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td style="padding: 5px 0;" x-text="opnameGudangNoteData.tanggal_opname"></td>
                            </tr>
                            <tr>
                                <td style="padding: 5px 0; font-weight: bold;">Lokasi:</td>
                                <td style="padding: 5px 0;" x-text="opnameGudangNoteData.lokasi"></td>
                            </tr>
                        </table>
                    </div>
                    <div>
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td style="padding: 5px 0;" x-text="opnameGudangNoteData.pic_opname"></td>
                            </tr>
                            <tr>
                ...
                <table style="width: 100%; border-collapse: collapse; margin-top: 20px; font-size: 14px;">
                    ...
                    <tbody>
                        <template x-for="(item, index) in opnameGudangNoteData.items" :key="index">
                            <tr>
                                <td style="padding: 8px; border: 1px solid #ddd; text-align: center;"
                                    x-text="index + 1"></td>
                                <td style="padding: 8px; border: 1px solid #ddd;" x-text="item.nama_barang"></td>
                                <td style="padding: 8px; border: 1px solid #ddd; text-align: center;"
                                    x-text="item.stok_sistem"></td>
                                <td style="padding: 8px; border: 1px solid #ddd; text-align: center;"
                                    x-text="item.stok_fisik"></td>
                                <td style="padding: 8px; border: 1px solid #ddd; text-align: center; font-weight: bold;"
                                    :style="item.selisih < 0 ? 'color: red;' : (item.selisih > 0 ? 'color: orange;' : 'color: green;')"
                    ...
                    <tfoot>
                        <tr style="background-color: #f9f9f9; font-weight: bold;">
                            ...
                            <td colspan="5" style="padding: 10px; border: 1px solid #ddd; text-align: left;"
                                x-text="opnameGudangNoteData.items.length + ' Items'"></td>
                        </tr>
                    </tfoot>
                </table>
                ...
                <div
                    ...
                    <div>
                        ...
                        <p style="margin: 0; border-top: 1px solid #000; display: inline-block; padding-top: 5px; min-width: 150px;"
                            x-text="opnameGudangNoteData.pic_opname"></p>
                    </div>
                    <div>
                        <p style="margin: 0; font-weight: bold;">Saksi / Gudang,</p>
                        <div style="height: 70px;"></div>
                        <p
